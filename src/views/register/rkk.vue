    ...
    <el-row>
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
        <el-form
          ...
          size="mini"
        >
          <div class="title-tips">账号注册(人口库)</div>
...
export default {
  ...
  methods: {
    ...
    handleReister() {
      ...
      this.loading = true
      const reisterData = this.api.getAdminRegister(this.globals.tableName.user, this.globals.typeName.rkk, data)
